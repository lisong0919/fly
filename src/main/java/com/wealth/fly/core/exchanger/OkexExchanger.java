...
public class OkexExchanger implements Exchanger {
  ...
  public List<KLine> getKlineData(String currency, String startTime, String endTime,
  ...
  private static String transferTimeToSystemStandard(String time) {
    ...
    return DateUtil
        .transferTime(time, CommonConstants.OK_DATE_FORMAT, CommonConstants.SYSTEM_DATE_FORMAT);
  }

  private static String transferTimeToOkexStandard(String time) {
    return DateUtil
        .transferTime(time, CommonConstants.SYSTEM_DATE_FORMAT, CommonConstants.OK_DATE_FORMAT);
  }
